...
import 'package:app9ids1/Models/Consultorioresponse2.dart';
import 'package:app9ids1/Models/Doctorresponse2.dart';
...
class _CitaDetailPageState extends State<CitaDetailPage> {
  ...
  Future<void> obtenerDoctor(int iddoc) async {
    try {
      ...
      if (response.statusCode == 200) {
        final Map<String, dynamic> data = jsonDecode(response.body);
        final doctor = Doctorresponse2.fromJson(data);
        setState(() {
  ...
  Future<void> obtenerConsultorio(int idcon) async {
    try {
      ...
      if (response.statusCode == 200) {
        final Map<String, dynamic> data = jsonDecode(response.body);
        final consultorio = Consultorioresponse2.fromJson(data);
        setState(() {
