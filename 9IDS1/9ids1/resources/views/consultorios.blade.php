...
<center>
        ...
        <div class="box-body">
            ...
            <thead style=" background-color:#00866e; color:#fff">
                ...
                <tr>
                    <td class=" animate__delay-1s">{{$consultorio['numero']}}</td>
                    <td class=" animate__delay-1s">{{$consultorio['edificio']}}</td>
                    <td class=" animate__delay-1s">{{$consultorio['nivel']}}</td>
                    <td>
                          
                          <a href="{{route('consultorio.nuevo',['id' => $consultorio['id']])}}" class="btn btn-success btn-sm rounded-8  animate__delay-1s">
                      ...
                      <td>
                                <a>
                                <form action="{{route('consultorio.borrar',['id' => $consultorio['id']])}}" class="formulario-eliminar" method="POST" >
                                    @csrf
                                    @method('DELETE')
